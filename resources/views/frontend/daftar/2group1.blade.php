        ...
        <div class="block-content block-content-full">
            ...
            <div class="form-group form-row">
                ...
                <div class="col-6">
                    ...
                    <input class="js-maxlength form-control" type="text" id="ktp" name="ktp" placeholder="NIK (No. KTP)..." minlength="16" maxlength="16" data-always-show="true" data-warning-class="badge badge-primary" data-limit-reached-class="badge badge-primary" value="{{ $pegawai['nik'] }}" required>
                </div>                                    
            </div>
            <div class="form-group form-row">
                <div class="col-6">
                <label for="instansi">Nama Lengkap</label>
                    <input class="form-control" type="text" id="nama_lengkap" name="nama_lengkap" placeholder="Nama Lengkap..." value="{{ $pegawai['nama_lengkap'] }}" required>
                </div>
                <div class="col-6">
                        <label for="instansi">Nama Panggilan</label>
                    <input class="form-control" type="text" id="nama_panggil" name="nama_panggil" placeholder="Nama Panggilan..." value="{{ $pegawai['nama'] }}" required>
                </div>
            </div>
            <div class="form-group">
                <label for="instansi">Alamat</label>
                <textarea class="form-control" name="alamat" placeholder="Alamat..." required>{{ $pegawai['alamat'] }}</textarea>
            </div>                                
            <div class="form-group form-row">
                <div class="col-6">
                    <label for="instansi">Tempat Lahir</label>
                    <input class="form-control" type="text" id="tmp_lahir" name="tmp_lahir" placeholder="Tempat Lahir..." value="{{ $pegawai['tmp_lahir'] }}" required>
                </div>
                <div class="col-6">
                    <label for="instansi">Tanggal Lahir</label>
                    <input class="js-datepicker form-control" type="text" id="tgl_lahir" name="tgl_lahir" placeholder="Tanggal Lahir" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="yyyy-mm-dd" value="{{ $pegawai['tgl_lahir'] }}" required>
                </div>
            </div>  
            <div class="form-group form-row">
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <select class="form-control" id="agama" name="agama" style="width: 100%;" required>
                        ...
                        @foreach ($agama as $a)
                        <option value="{{ $a->id }}" {{ $pegawai['agama'] == $a->id ? 'selected' : ''}}>{{ $a->nama }}</option>                                    
                        @endforeach
                    </select>
                </div>
            </div>                                
            <div class="form-group form-row">
                <div class="col-6">
                    ...
                    <input class="form-control" type="text" id="hp" name="hp" placeholder="No. Handphone..." value="{{ $pegawai['telp'] }}" required>
                </div>
                <div class="col-6">
                    <label for="instansi">Email</label>
                    <input class="form-control" type="email" id="email" name="email" placeholder="Email..." value="{{ $pegawai['email'] }}" required>
                </div>
            </div>              
            <div class="form-group form-row">
                <div class="col-6">
                    ...
                    <select class="form-control" id="marital" name="marital" style="width: 100%;" required>
                        ...
                        <option value="1" {{ $pegawai['marital'] == 1 ? 'selected' : ''}}>Menikah</option>
                        <option value="2" {{ $pegawai['marital'] == 2 ? 'selected' : ''}}>Belum Menikah</option>
                        <option value="3" {{ $pegawai['marital'] == 3 ? 'selected' : ''}}>Duda</option>
                        <option value="4" {{ $pegawai['marital'] == 4 ? 'selected' : ''}}>Janda</option>
                    </select>
                </div>
                <div class="col-6">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="jabatan" name="jabatan" placeholder="Jabatan..." value="{{ $pegawai['jabatan'] }}" required>
            </div>
            <h2 class="content-heading pt-3 mb-3">Data Instansi & Unit Kerja</h2>
            <div class="form-group">
                <label for="instansi">Instansi</label>
                <input class="form-control" type="text" id="instansi" name="instansi" value="{{ $pegawai['instansi'] }}" readonly required>
            </div>
            <div class="form-group">
                <label for="instansi">Satuan Kerja (SKPD/OPD)</label>
                <input class="form-control" type="text" id="satker_nama" name="satker_nama" value="{{ $pegawai['satker_nama'] }}" placeholder="Satuan Kerja..." readonly required>
            </div>
            <div class="form-group">
                <label for="instansi">Alamat</label>
                <textarea class="form-control" id="satker_alamat" name="satker_alamat" placeholder="Alamat Satuan Kerja..." readonly required>{{ $pegawai['satker_alamat'] }}</textarea>
            </div>    
            <div class="form-group form-row">
                <div class="col-6">
                <label for="instansi">No. Telepon</label>
                <input class="form-control" type="text" id="satker_telp" name="satker_telp" value="{{ $pegawai['satker_telp'] }}" placeholder="No. Telepon Satuan Kerja" readonly required>
                </div>
            </div>                                                                                             
        </div>
