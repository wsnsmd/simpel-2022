...
<body>
    ...
    <div id="container">
        <div style="text-align: center; margin-left: 0px; margin-right: 0px; margin-top: 20px">
                    ...
                    <tr>
                        <td style="vertical-align: top">
                            <table width="100%" cellspacing="0" border="0"
                                ...
                                <tbody>
                                    <tr>
                                        <td rowspan="8" width="14%" style="vertical-align: top; text-align: center;"><img style="border: 2px solid;" src="" height="200px" /></td>
                                        <td width="22%">Nama</td>
                                        <td width="2%">:</td>
			...
			<p>Pada {!! $jadwal->nama !!} Tahun {!! $jadwal->tahun !!} yang diselenggarakan oleh Badan Pengembangan Sumber Daya Manusia Provinsi Kalimantan Timur dari tanggal {!! formatTanggal($jadwal->tgl_awal) !!} sampai dengan {!! formatTanggal($jadwal->tgl_akhir) !!} yang meliputi {!! $jadwal->total_jp !!} JP (Jam Pelajaran).</p>
        </div>
        <div id="tt1">
