...
<body>
    ...
    <div id="container">
        <div style="text-align: center; margin-left: 0px; margin-right: 0px; margin-top: 20px">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="3"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>NIP</td>
                                        <td>:</td>
                                        <td>{!! formatNIP($sertPeserta->nip) !!}</td>
                                    </tr>                                    
									<tr>
                                        <td>Pangkat / Golongan</td>
                                        <td>:</td>
                                        <td>{!! $sertPeserta->pangkat !!}, {!! $sertPeserta->golongan !!}</td>
                                    </tr>
                                    <tr>
			...
			<p>pada Pelatihan {!! $jadwal->nama !!} Tahun {!! $jadwal->tahun !!} yang diselenggarakan oleh Badan Pengembangan Sumber Daya Manusia Provinsi Kalimantan Timur dari tanggal {!! formatTanggal($jadwal->tgl_awal) !!} sampai dengan {!! formatTanggal($jadwal->tgl_akhir) !!} di Samarinda yang meliputi {!! $jadwal->total_jp !!} jam pelajaran.</p>
        </div>
        <div id="tt1">
