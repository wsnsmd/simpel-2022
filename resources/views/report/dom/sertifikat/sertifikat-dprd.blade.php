...
<body>
        ...
        <tbody>
            <tr>
                <td style="text-align: center">
                    <span style="font-weight: bold; font-size: 12pt; font-family: bookman; line-height: 1.0;">PEMERINTAH PROVINSI</span><br>
                    <span style="font-weight: bold; font-size: 12pt; font-family: bookman; line-height: 1.0;">KALIMANTAN TIMUR</span><br>
                    <span style="font-weight: bold; font-size: 14pt; font-family: bookman; line-height: 1.5;">SERTIFIKAT</span><br>
    ...
    <div id="container">
        <div style="text-align: center; margin-left: 0px; margin-right: 0px; margin-top: 20px">
			<p>Gubernur Kalimantan Timur berdasarkan Peraturan Pemerintah Nomor 12 Tahun 2017 tentang Pembinaan dan Pengawasan Penyelenggaraan Pemerintah Daerah dan Peraturan Menteri Dalam Negeri Nomor 6 Tahun 2024 tentang Orientasi dan Pendalaman Tugas Anggota DPRD Provinsi dan Anggota DPRD Kabupaten/Kota serta Ketentuan-ketentuan Pelaksanaannya, menyatakan bahwa :</p>
                        ...
                        <td style="vertical-align: top">
                            <table width="100%" cellspacing="0" border="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="vertical-align: top">Partai Politik</td>
			...
			<p>Orientasi bagi Anggota Dewan Perwakilan Rakyat Daerah Kabupaten/Kota ... Tahun {!! $jadwal->tahun !!} yang diselenggarakan oleh Badan Pengembangan Sumber Daya Manusia Provinsi Kalimantan Timur, dari tanggal {!! formatTanggal($jadwal->tgl_awal) !!} sampai dengan {!! formatTanggal($jadwal->tgl_akhir) !!} yang meliputi {!! $jadwal->total_jp !!} JP (Jam Pelajaran).</p>
        </div>
        <div id="tt1">
            <table cellspacing="0" cellpadding="0" class="mdiklat">
                ...
                <tr>
                    <td style="padding-bottom: 100px">Sekretaris Daerah,</td>
                </tr>
                <tr>
    ...
    <div id="container2">
        <table width="100%" cellspacing="0" cellpadding="0" class="header" style="margin-top: 2cm;">
            <tbody>
                <tr>
                    <td style="text-align: center">
                        <span style="font-weight: bold; font-size: 12pt; font-family: bookman; line-height: 1.0;">DAFTAR MATERI PEMBELAJARAN</span><br>
                    </td>
                </tr>
            </tbody>
        </table>
        <table width="90%" cellspacing="0" cellpadding="2" class="header" style="margin: 30px auto; border: 2px solid;">
            <thead>
                <tr>
                    <th width="5%" style="border-right: 2px solid; border-bottom: 2px solid; padding-top: 15px; padding-bottom: 15px; vertical-align: center; text-align: center"><span style="font-weight: bold;">NOMOR</span></th>
                    <th style="border-bottom: 2px solid; padding-top: 15px; padding-bottom: 15px; vertical-align: center; text-align: center"><span style="font-weight: bold;">MATERI PEMBELAJARAN</span></th>
                </tr>
            </thead>
            <tbody>
