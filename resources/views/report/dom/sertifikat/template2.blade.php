...
<body style='background-image: url("/media/images/template2.jpg"); background-size: contain; background-repeat: no-repeat;'>
        ...
        <tbody>
            <tr>
                <td style="text-align: center">
                    <span style="font-weight: bold; font-size: 14pt; font-family: bookman">PEMERINTAH PROVINSI KALIMANTAN TIMUR</span><br>
                    <span style="font-weight: bold; font-size: 18pt; font-family: bookman">SERTIFIKAT</span><br>
                    <span style="font-size: 10pt; font-family: bookman">Nomor : {!! $sertPeserta->nomor !!}</span>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <div id="container">
        <div style="text-align: center; margin-left: 0px; margin-right: 0px; margin-top: 20px">
			...
			<p>Dalam {!! $jadwal->nama !!} Tahun {!! $jadwal->tahun !!} yang dilaksanakan oleh Badan Pengembangan Sumber Daya Manusia Provinsi Kalimantan Timur pada tanggal {!! formatTanggal($jadwal->tgl_awal) !!}.</p>
        </div>
        <div id="tt1">
