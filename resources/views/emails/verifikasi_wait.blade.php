                                                ...
                                                <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td class="text center-text" valign="middle" align="center"
                                                            ...
                                                            pada tanggal <strong>{{ $jadwal->tgl_awal}}</strong> s/d <strong>{{ $jadwal->tgl_akhir}}</strong> <br>
                                                            anda sedang direview oleh <strong>BPSDM Prov. Kaltim</strong> <br><br>
 
                                                            Untuk melihat status peserta pelatihan anda bisa diklik dibawah ini
                                                                                ...
                                                                                <table border="0" cellpadding="0"
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td valign="middle"
                                                                                                align="center"
                                                                                                style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:14px;font-weight:normal;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">

                                                                                                <a href="{{ route('jadwal.detail', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama)]) }}"
                                                                                                    target="_blank"
                                                                                                    style="color: #FFFFFF;">Cek Peserta</a>
